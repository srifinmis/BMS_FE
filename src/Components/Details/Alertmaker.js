...
const UTRmaker = ({ isDropped }) => {
    ...
    useEffect(() => {
        const fetchLenderDetails = async () => {
            try {
                console.log("Fetching lender details with params:", lender_code, sanction_id, tranche_id, approval_status, createdat)
                const response = await axios.get(`${API_URL}/alert/details`, {
                    params: { lender_code, sanction_id, tranche_id, approval_status, createdat },
                });
